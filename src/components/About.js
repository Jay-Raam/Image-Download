        ...
        <div className="container">
          <div className="home">
            <div className="text">
              ...
              <p>
                Welcome to my Gallery, where you can explore a vast collection
                of stunning images sourced from the Pexels API. Whether you're
        ...
        <div className="container">
          ...
          <div>
            ...
            <p className="para">
              ...
              yourself in a world of captivating visuals, curated to inspire and
              delight.
            </p>
            <ul className="main-9 ">
              <li className="main-10">
      ...
      <div className="explore">
        <div className="container">
          <div className="flex-2">
            ...
            <p>
              <span>W</span>hether you're seeking a moment of inspiration or
              simply looking to brighten your day with beautiful visuals, my
              gallery is here to ignite your imagination and elevate your
              browsing experience.
            </p>
            <ul className="main-9 ">
              <li className="main-10">
